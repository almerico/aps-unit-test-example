...
public class Example1Test {
	...
	public void test() throws Exception {
		...
		String bpmnResourcePath = "app/bpmn-models/TestProcess-58058.bpmn20.xml";
		...
		activitiRule.getRepositoryService().createDeployment().name(appName).addClasspathResource(bpmnResourcePath).deploy();
