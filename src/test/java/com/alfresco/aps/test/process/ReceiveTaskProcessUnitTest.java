...
public class ReceiveTaskProcessUnitTest extends AbstractTest {

	static // Process info.
	String appName = "Test App";
	static String appResourcePath = "app";
	String processDefinitionKey = "ReceiveTaskProcess";
	...
	public void testProcessExecution() throws Exception {
		...
		unitTestHelpers.assertReceiveTask(1, null, true, null);
